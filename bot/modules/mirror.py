...
from bot.helper.ext_utils.bot_utils import is_url, is_magnet, is_gdtot_link, is_gdrive_link, is_appdrive_link, is_sharerpw_link, is_mega_link, is_gdrive_link, get_content_type, get_readable_time
...
class MirrorListener:
    ...
    def onDownloadError(self, error, markup=False, button=None):
        ...
        if markup == True:
            sendMarkup(msg, self.bot, self.message, button)
        else:
