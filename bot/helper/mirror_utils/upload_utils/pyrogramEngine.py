...
from bot import AS_DOCUMENT, user_data, CUSTOM_FILENAME, EXTENSION_FILTER, DUMP_CHAT, app, LEECH_SPLIT_SIZE
...
class TgUploader:
    ...
    def cancel_download(self):
        ...
        self.__listener.onUploadError('Upload kamu telah dihentikan!')
