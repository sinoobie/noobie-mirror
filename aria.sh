...
aria2c --enable-rpc=true --check-certificate=false --daemon=true \
   ...
   --max-overall-download-limit=0 --bt-tracker="[$tracker_list]" --bt-tracker-connect-timeout=300 \
   --disk-cache=32M --max-overall-upload-limit=1K --max-concurrent-downloads=15 --summary-interval=0 \
   --peer-id-prefix=-qB4400- --user-agent=qBittorrent/4.2.5 --peer-agent=qBittorrent/4.4.0 \
