...
aria2c --enable-rpc=true --check-certificate=false --daemon=false \
   ...
   --bt-stop-timeout=300 --min-split-size=10M --split=10 --allow-overwrite=true \
   ...
   --peer-id-prefix=-qB4400- --user-agent="Mozilla/5.0 (X11; Ubuntu; Linux x86_64; rv:95.0) Gecko/20100101 Firefox/95.0" \
   --peer-agent=qBittorrent/4.4.0 --bt-enable-lpd=true --seed-time=0 --max-file-not-found=0 \
   --max-tries=20 --auto-file-renaming=true --reuse-uri=true --http-accept-gzip=true --continue=true \
